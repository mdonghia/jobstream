    ...
    <>
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="mb-4">
        <TabsList className="bg-transparent rounded-none w-full justify-start h-auto p-0 gap-1 border-b border-[#E3E8EE] overflow-x-auto overflow-y-hidden">
          <TabsTrigger value="ALL" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            All
            <span className={`ml-1.5 text-xs rounded-full px-1.5 py-0.5 ${activeTab === "ALL" ? "bg-[#635BFF]/10 text-[#635BFF]" : "bg-gray-100 text-[#8898AA]"}`}>
              {allCount}
            </span>
          </TabsTrigger>
          <TabsTrigger value="DRAFT" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            Draft
          ...
          <TabsTrigger value="OUTSTANDING" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            Outstanding
          ...
          <TabsTrigger value="OVERDUE" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            Overdue
          ...
          <TabsTrigger value="PAID" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            Paid
            <span className={`ml-1.5 text-xs rounded-full px-1.5 py-0.5 ${activeTab === "PAID" ? "bg-[#635BFF]/10 text-[#635BFF]" : "bg-gray-100 text-[#8898AA]"}`}>
              {statusCounts.PAID ?? 0}
            </span>
          </TabsTrigger>
          <TabsTrigger value="VOID" className="px-3 py-2 border-b-2 border-transparent -mb-px text-[#8898AA] hover:text-[#425466] data-[state=active]:border-[#635BFF] data-[state=active]:text-[#0A2540]">
            Void
