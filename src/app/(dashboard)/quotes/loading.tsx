export default function QuotesLoading() {
  return (
    <div>
      ...
      {/* Tabs skeleton */}
      <div className="flex gap-1 mb-4 border-b border-[#E3E8EE] pb-0">
        {[60, 50, 40, 65, 60, 55].map((w, i) => (
          <div
            key={i}
            className="h-10 bg-gray-200 rounded-t animate-pulse"
            style={{ width: w }}
          />
        ))}
      </div>
